        ...
        public override void OnReceive(Context context, Intent intent) {
            ...
            switch (intent.Action) {
                case "chosen_green":
                    ...
                    PendingIntent pendingIntentGreen = PendingIntent.GetBroadcast(context, 0, intent, PendingIntentFlags.Immutable);
                    widgetView.SetOnClickPendingIntent(Resource.Id.color_press_game_widget_color_green, pendingIntentGreen);
                    break;
                case "chosen_blue":
                    ...
                    PendingIntent pendingIntentBlue = PendingIntent.GetBroadcast(context, 0, intent, PendingIntentFlags.Immutable);
                    widgetView.SetOnClickPendingIntent(Resource.Id.color_press_game_widget_color_blue, pendingIntentBlue);
                    break;
                case "chosen_red":
                    ...
                    PendingIntent pendingIntentRed = PendingIntent.GetBroadcast(context, 0, intent, PendingIntentFlags.Immutable);
                    widgetView.SetOnClickPendingIntent(Resource.Id.color_press_game_widget_color_red, pendingIntentRed);
                    break;
                case "chosen_purple":
                    ...
                    PendingIntent pendingIntentPurple = PendingIntent.GetBroadcast(context, 0, intent, PendingIntentFlags.Immutable);
                    widgetView.SetOnClickPendingIntent(Resource.Id.color_press_game_widget_color_purple, pendingIntentPurple);
                    break;
                case "chosen_white":
                    ...
                    PendingIntent pendingIntentWhite = PendingIntent.GetBroadcast(context, 0, intent, PendingIntentFlags.Immutable);
                    widgetView.SetOnClickPendingIntent(Resource.Id.color_press_game_widget_color_white, pendingIntentWhite);
                    break;
                default:
